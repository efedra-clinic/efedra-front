          ...
          <div className="w-full flex flex-col md:flex-row-reverse md:justify-end md:gap-[40px] xl:gap-[54px] mb-15 min-[360px]:mb-[132px] xs:mb-10 lg:mb-0">
            <div className="w-full flex flex-col mb-7 md:mb-0  md:max-w-[314px]">
              <motion.p
                ...
                className="mb-[15px] lg:mb-[16px] text-[12px] md:text-[13px] leading-[125%] md:leading-[123%]"
              >
                {t("description1")}
              </motion.p>
              <motion.p
                ...
                viewport={{ once: true, amount: 0.3 }}
                variants={fadeInAnimation({ y: 20, delay: 0.3 })}
                className="text-[12px] md:text-[13px] leading-[125%] md:leading-[123%]"
              >
                {t("description2")}
              </motion.p>
            </div>
            <motion.div
              ...
              className="relative w-full md:w-[calc(50%)] lg:w-[calc(50%+30px)] xl:w-[calc(50%+32px)] h-[195px] xs:h-[280px] sm:h-[320px] md:h-auto lg:h-[350px] xl:h-[425px] overflow-hidden rounded-[20px]"
            >
              <Image
